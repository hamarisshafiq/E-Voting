...
<div class="container mt-5">
    ...
    <div class="dashboard-header">
        <div>
            <h3 class="mb-0" style="color: var(--primary-color);">Dashboard</h3>
            <p class="text-muted mb-0">Welcome back, <strong><?php echo $_SESSION['user_name']; ?></strong> 👋</p>
        </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100" style="background: linear-gradient(135deg, var(--primary-color), var(--primary-hover)); border:none;">
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100" style="background: linear-gradient(135deg, var(--success-color), #059669); border:none;">
                <div class="stat-card-inner">
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100" style="background: linear-gradient(135deg, #334155, #1e293b); border:none;">
                <div class="stat-card-inner">
                    <h5>My Vote Status</h5>

                    <?php if($myVote){ ?>
                        <div class="mt-2">
                            <span class="badge bg-success mb-1">✔ Voted</span><br>
                            <span style="font-size: 1.2rem; font-weight: 600;"><?php echo $myVote['name']; ?></span><br>
                            <small style="opacity: 0.8;"><?php echo $myVote['party']; ?></small>
                        </div>
                    <?php } else { ?>
                        <div class="mt-2">
                            <span class="badge bg-warning text-dark px-3 py-2" style="font-size: 1rem;">❌ Not Voted Yet</span>
                        </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <?php if ($user['has_voted'] == 1) { ?>
        <div class="alert alert-success mt-3 shadow-sm text-center">
            <strong>✅ Thank you!</strong> You have successfully cast your vote.
        </div>
    <?php } ?>

    <!-- CANDIDATES -->
    <h4 class="mt-5 mb-4" style="font-weight: 700; color: var(--text-main);">Election Candidates</h4>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
            ...
            <div class="card h-100 mt-4 interactive-card pt-0">
                ...
                <div class="candidate-card-body">
                    <h5 style="font-weight: 700; color: var(--text-main); margin-bottom: 5px;"><?php echo $row['name']; ?></h5>
                    
                    <div class="mb-3">
                        <span class="badge bg-primary px-3 py-1"><?php echo $row['party']; ?></span>
                        <span class="badge bg-secondary px-3 py-1"><?php echo $row['city']; ?></span>
                    </div>

                    <div class="mt-4">
                        <?php if ($user['has_voted'] == 0) { ?>
                            <a href="vote.php?cid=<?php echo $row['id']; ?>"
                               class="btn btn-success w-100" style="padding: 10px;">
                                Vote for <?php echo $row['name']; ?>
                            </a>
                        <?php } else { ?>
                            <button class="btn btn-secondary w-100" disabled style="padding: 10px; opacity: 0.7;">Voted</button>
                        <?php } ?>
                    </div>
                </div>
