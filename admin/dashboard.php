...
$isResultPublished = isset($settings['is_result_published']) 
                     ? $settings['is_result_published'] 
                     : 0;
?>
...
<div class="container mt-5">
    ...
    <div class="dashboard-header mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                Control panel and election management
            </p>
        </div>
    ...
    <!-- RESULT STATUS -->
    <?php if($isResultPublished == 1){ ?>

        <div class="alert alert-info d-flex align-items-center shadow-sm mb-4">
            <span style="font-size: 1.5rem; margin-right: 15px;">🏆</span>

            <div>
                <strong>Results Published</strong><br>
                <small>Users can now view the election winner.</small>
            </div>
        </div>
    ...
    <!-- MAIN PANELS -->
    <h5 class="mb-3" style="font-weight: 600; color: var(--text-muted);">
        Manage Election
    </h5>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card h-100 interactive-card p-4 text-center">
                ...
                <a href="results.php"
                   class="btn btn-warning w-100 mt-auto text-dark"
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card h-100 interactive-card p-4 text-center">
                ...
                <a href="clear_result.php"
                   class="btn btn-dark w-100 mt-auto"
                   onclick="return confirm('Are you sure you want to completely clear all votes and results?');">
